...
return [
    ...
    */
    ...
    'classes_sidebar_nav' => '',
    'classes_topnav' => 'navbar-white navbar-light elevation-2',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon' => 'fa fa-search',
            'icon_color' => 'blue',
            'route' => 'busqueda_movimientos'
        ],
        [
            'text' => 'Búsqueda de sabanas',
            'can' => 'sistemas',
            'icon' => 'fas fa-list',
            'icon_color' => 'green',
            'route' => 'busqueda_sabanas'
        ],
        ...
        'Axios' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/axios/0.19.2/axios.min.js',
                ],
            ],
        ],
        'Datatables' => [
        ...
        'Datatables_buttons' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/1.7.1/css/buttons.dataTables.min.css',
                ],
            ],
        ],
        'Jszip' => [
        ...
        'Galeria' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/viewerjs/1.10.2/viewer.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/viewerjs/1.10.2/viewer.min.css',
                ],
            ],
        ],
        'Html5_buttons' => [
